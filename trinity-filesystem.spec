...
install -d -m 755 %{?buildroot}%tde_datadir/apps/tdedisplay
install -d -m 755 %{?buildroot}%tde_datadir/apps/tdedisplay/color-schemes
...
install -d -m 755 %{?buildroot}%tde_datadir/mime
install -d -m 755 %{?buildroot}%tde_datadir/mime/packages
...
install -d -m 755 %{?buildroot}%tde_datadir/tdestyle
install -d -m 755 %{?buildroot}%tde_datadir/tdestyle/themes
install -d -m 755 %{?buildroot}%tde_datadir/X11/xkb/symbols
...
install -d -m 755 %{?buildroot}%tde_tdedocdir/HTML/gl/common
...
install -d -m 755 %{?buildroot}%tde_tdedocdir/HTML/sr@Latn/common
...
install -d -m 755 %{?buildroot}%tde_tdedocdir/HTML/zh_Hans/common
...
install -d -m 755 %{?buildroot}%tde_datadir/locale/l10n/braille
...
install -d -m 755 %{?buildroot}%tde_datadir/locale/l10n/eo
...
install -d -m 755 %{?buildroot}%tde_datadir/locale/l10n/jv
...
install -d -m 755 %{?buildroot}%tde_datadir/locale/l10n/mi
...
install -d -m 755 %{?buildroot}%tde_datadir/locale/ca@valencia/LC_MESSAGES/
...
install -d -m 755 %{?buildroot}%tde_datadir/locale/fy/LC_MESSAGES/
install -d -m 755 %{?buildroot}%tde_datadir/locale/ga/LC_MESSAGES/
install -d -m 755 %{?buildroot}%tde_datadir/locale/gl/LC_MESSAGES/
install -d -m 755 %{?buildroot}%tde_datadir/locale/gu/LC_MESSAGES/
...
install -d -m 755 %{?buildroot}%tde_datadir/locale/kk/LC_MESSAGES/
...
install -d -m 755 %{?buildroot}%tde_datadir/locale/lv/LC_MESSAGES/
install -d -m 755 %{?buildroot}%tde_datadir/locale/mk/LC_MESSAGES/
install -d -m 755 %{?buildroot}%tde_datadir/locale/mr/LC_MESSAGES/
...
install -d -m 755 %{?buildroot}%tde_datadir/locale/si/LC_MESSAGES/
...
install -d -m 755 %{?buildroot}%tde_datadir/locale/ug/LC_MESSAGES/
...
install -d -m 755 %{?buildroot}%tde_datadir/locale/zh_Hans/LC_MESSAGES/
...
%changelog
* Sun Jul 27 2025 Petr Akhlamov <ahlamovpm@basealt.ru> 14.1.3-alt1_1
